  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (currentTetromino != null) {
      ...
      Paint paint = new Paint()
        ..color =
            UIUtils.tetrominoColor(currentTetromino!.type).withOpacity(0.5);
      ...
      for (int j = blocks.length - 1; j >= 0; j--) {
        ...
        if (blocks[j][blocks[j].length - 1] != null) {
          rightFound = true;
      ...
      // left line
      Offset p1 = Offset(
          currentTetromino!.x * cellSize,
          (currentTetromino!.y + currentTetromino!.height + leftOffset) *
              cellSize);
      ...
      // right line
      Offset p3 = Offset(
          (currentTetromino!.x + currentTetromino!.width) * cellSize,
          (currentTetromino!.y + currentTetromino!.height + rightOffset) *
              cellSize);
